...
categories:
  ...
  - AWS S3
  - cron
description: 'An introduction to working with AWS S3 from R and a step-by-step workflow to set an AWS Lambda functon to save datasets to an S3 bucket on a weekly schedule'
projects: ['r2lambda']
---
