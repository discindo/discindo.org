...
description: 'A demo of two newly added features in the `{r2lambda}` R package. How to deploy R projects with multiple files, and how to use the `{renv}` lockfile to manage dependencies in the AWS Lambda docker image'
projects: ['r2lambda']
---
