...
date: '2023-01-20'
description: 'A guide on setting up Rstudio server on an AWS EC2 instance for users with older laptops, including steps for installation, configuration, and secure access.'
categories:
  - R
  - Rstudio
  - AWS
