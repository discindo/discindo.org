...
categories:
  ...
  - uv
  - GitHub Actions
description: 'A step-by-step guide to work with a Python Shiny app with the help of uv and a GitHub Actions workflow to have it published from GitHub to Posit Connect.'
---
...
[blog post](/posts/pkg-env/2022-11-18-packaging-a-python-shiny-app/index.html) where I describe a simple approach 
