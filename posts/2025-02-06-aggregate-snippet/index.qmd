...
This post continues what I started last time, when I described an approach
...
know what the user might request. Creating an flexible interface, where
...
again using `{checkmate}` because its awesome. We can make sure that the inputs 
...
harvest the user's selections from the input and construc the list of instructions before
