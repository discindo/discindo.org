...
categories:
  ...
  - wikidata
  - shiny
description: "Building a PyShiny app for displaing data from Wikidata"
---


In the [previous post](/posts/using-wikidata-to-draw-networks-of-politically-exposed-persons-1) I outlined the approach to query data from Wikidata, 
