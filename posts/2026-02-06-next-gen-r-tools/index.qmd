...
Whether it is a case of [Carcinisation](https://en.wikipedia.org/wiki/Carcinisation) or not, it seems we are now in the age where different tools for making the R language ecosystem better, faster, or more consistent are being built. In the R-world it definitely feels like an effort to catch up with what [Astral.sh](https://github.com/astral-sh) has done for python.
