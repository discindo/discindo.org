...
categories:
  ...
  - brochure
description: >
    In this post, I share my experience building a multi-session Shiny application using the {brochure} package. 
    I discuss the advantages of using {brochure} for creating independent Shiny sessions for different pages, 
    the integration with {golem}, and the steps to deploy the application on shinyapps.io. 
    Additionally, I provide a solution for handling URL redirects in different environments.
---
